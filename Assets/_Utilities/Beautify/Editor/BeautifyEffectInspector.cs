...
namespace BeautifyEffect
{
	...
	public class BeautifyEffectInspector : Editor
	{
        ...
        SerializedProperty _bloomBoost0, _bloomBoost1, _bloomBoost2, _bloomBoost3, _bloomBoost4, _bloomBoost5, _bloomBlur, _bloomQuickerBlur, _preRenderCameraEvent;
		...
		public override void OnInspectorGUI ()
		{
			...
			if (expandSharpenSection) {
				if (_effect.cameraEffect != null && !_effect.cameraEffect.orthographic && _quality.intValue != (int)BEAUTIFY_QUALITY.Basic) {
					bool isMinMaxDepthSharpenEnabled = shaderAdvancedOptionsInfo != null && shaderAdvancedOptionsInfo.GetAdvancedOptionState ("BEAUTIFY_DEPTH_BASED_SHARPEN");
					if (isMinMaxDepthSharpenEnabled) {
